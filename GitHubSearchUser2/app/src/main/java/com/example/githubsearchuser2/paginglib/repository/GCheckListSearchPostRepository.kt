...
package com.example.githubsearchuser2.paginglib.repository
 ...
 */
interface GCheckListSearchPostRepository {
    fun postsOfGCheckListSearch(subUserID: String, pageKey: Int, limitKey: Int, searchUser: String, pageSize: Int): Listing<WebClientPostCheckListSearch>
